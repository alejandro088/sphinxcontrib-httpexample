...
snapshots['test_fixture[build_httpie_command-fixture_002] 1'] = 'echo "{\\"@type\\": \\"Document\\",\\"title\\": \\"My Document\\"}" | http POST http://localhost:8080/Plone/folder Accept:application/json Content-Type:application/json -a admin:admin'

snapshots['test_fixture[build_httpie_command-fixture_003] 1'] = 'echo "{\\"title\\": \\"My New Document Title\\"}" | http PATCH http://localhost:8080/Plone/folder/my-document Accept:application/json Content-Type:application/json -a admin:admin'

snapshots['test_fixture[build_httpie_command-fixture_009] 1'] = 'echo "{\\"/\\": {\\"fstype\\": \\"btrfs\\",\\"readonly\\": true,\\"storage\\": {\\"device\\": \\"/dev/sda1\\",\\"type\\": \\"disk\\"}},\\"/tmp\\": {\\"storage\\": {\\"sizeInMB\\": 64,\\"type\\": \\"tmpfs\\"}},\\"/var\\": {\\"fstype\\": \\"ext4\\",\\"options\\": [\\"nosuid\\"],\\"storage\\": {\\"label\\": \\"8f3ba6f4-5c70-46ec-83af-0d5434953e5f\\",\\"type\\": \\"disk\\"}},\\"/var/www\\": {\\"storage\\": {\\"remotePath\\": \\"/exports/mypath\\",\\"server\\": \\"my.nfs.server\\",\\"type\\": \\"nfs\\"}}}" | http PATCH http://localhost:8080/etc/fstab Accept:application/vnd.acme+json Accept-Encoding:"gzip, deflate" Content-Type:"application/vnd.acme+json; charset=utf-8" If-None-Match:\'"\'"abc123"\'"\' Authorization:"Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiYWRtaW4iOnRydWV9.TJVA95OrM7E2cBab30RMHrHDcEfxjoYZgeFONFh7HgQ"'

snapshots['test_fixture[build_httpie_command-fixture_012] 1'] = 'echo "{\\"max\\": 0.2,\\"min\\": 0.1}" | http POST http://localhost:8080/metrics Accept:application/json Content-Type:application/json -a admin:admin'
